...
# notes:
#
# - This script lacks the ability to filter by chain ID, and instead
#   calculates the product for all chains in the given PDB file.
#
...
if __name__ == '__main__':
    ...
    residue_surface_area(pdb, out, None)
